...
TARGET      := app_no_os_$(PDK_CORE_ID)_r5f_hello_world
TARGETTYPE  := exe
...
COMMON_CONFIG = $(abspath $(SITARA_APPS_DIR)/common/config/$(SITARA_DEMO_SOC))

# common library dependencies
COMMON_LIB = $(abspath $(SITARA_APPS_DIR)/common/libs)

# Provide list of C files by using built-in macro
CSOURCES    := main_r5f_hello_world.c

# Add directory to include path
IDIRS+=$(COMMON_LIB)
IDIRS+=$(COMMON_LIB)/sciclient/include
IDIRS+=$(COMMON_LIB)/profile/include
IDIRS+=$(COMMON_LIB)/logs/include
